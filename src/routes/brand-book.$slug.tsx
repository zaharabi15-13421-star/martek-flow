  ...
  notFoundComponent: () => (
    <div className="min-h-screen flex items-center justify-center bg-[#0A0A14] text-[#E2E8F0]">
      <div className="text-center">
        ...
        <a href="https://martek-flow.lovable.app" className="mt-6 inline-block text-[#A78BFA] hover:underline">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8">
          <div>
            ...
            <div className="mt-4 text-sm text-[#94A3B8]">
              Generated by{" "}
              <a href="https://martek-flow.lovable.app" className="text-[#A78BFA] hover:underline inline-flex items-center gap-1">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              href="https://martek-flow.lovable.app"
